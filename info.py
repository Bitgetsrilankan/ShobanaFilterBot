...
API_ID = int(environ.get('API_ID', '20711461'))
API_HASH = environ.get('API_HASH', '9139542df3b004d5941593407fe1c4bb')
...
PICS = (environ.get('PICS', 'https://i.ibb.co/hx3pkmpm/photo-5923786806845880078-y.jpg')).split()
...
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '-1002456874247').split()]
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002450577884')).split()]
