...
API_ID = int(environ.get('API_ID', '24870'))
API_HASH = environ.get('API_HASH', '9d635a36942af')
BOT_TOKEN = environ.get('BOT_TOKEN', '7221872059:-YWGkLy2l5pKfY')

# Bot settings
BOT_START_TIME = time()
CACHE_TIME = int(environ.get('CACHE_TIME', 300))
USE_CAPTION_FILTER = bool(environ.get('USE_CAPTION_FILTER', False))
PICS = (environ.get('PICS', 'https://graph.org/file/fa927909a305960b61acf-0113dc40b1e1533e79.jpg')).split()
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002442273549')).split()]
