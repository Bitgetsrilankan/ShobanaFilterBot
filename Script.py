class script(object):
    START_TXT = """ <blockquote>Hᴇʏ {} !</blockquote> <b>I'ᴍ ᴀɴ ᴀᴜᴛᴏ-ғɪʟᴛᴇʀ ʙᴏᴛ ᴛʜᴀᴛ ᴄᴀɴ ᴘʀᴏᴠɪᴅᴇ ᴍᴏᴠɪᴇs ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘs. Aᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴏʀ Rᴇǫᴜᴇsᴛ Hᴇʀᴇ sᴏ I ᴄᴀɴ ɢᴇᴛ sᴛᴀʀᴛᴇᴅ!</b><blockquote>𝖬𝖺𝗂𝗇𝗍𝖾𝗇𝖼𝖾 𝖡𝗒 --><tg-spoiler> BJ's Cᴏᴅᴇʀ</tg-spoiler></blockquote>"""
    HELP_TXT = """
     Hey  {} 
